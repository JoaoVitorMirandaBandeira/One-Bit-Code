let spaceShips = [];
function creteSpaceShip(name, pilot, crewLimit) {
    const spaceShip = {
        name,
        pilot,
        crewLimit,
...
function addCrewSpaceShip(nameSpaceShip, name) {
...
function sendSpaceShip(nameSpaceShip) {
    const spaceShip = findSpaceShip(nameSpaceShip);
    if (spaceShip) {
...
let control = true;
while (control) {
    let option = prompt(`Painel de controle:
            1 - Cadastrar Nave
